...
const getImageUrl = (index: number) => {
    const categories = [
        'wiki', 'knowledge', 'documentation', 'reference',
        'guide', 'tutorial', 'education', 'learning'
    ];
...
const wikiArticles: WikiArticle[] = [
    {
        ...
        summary: "A comprehensive guide to understanding and using Promises in JavaScript for asynchronous operations.",
    ...
    },
    {
        ...
        summary: "Everything you need to know about React Hooks, from useState and useEffect to custom hooks.",
        content: "Full article content here...",
        category: "React",
    ...
    },
    {
        ...
        summary: "Your first steps into TypeScript: setup, basic types, interfaces, and working with the compiler.",
        content: "Full article content here...",
        category: "TypeScript",
    ...
    },
    {
        ...
        summary: "Deep dive into Python decorators, with advanced patterns and real-world applications.",
        content: "Full article content here...",
        category: "Python",
    ...
    },
    {
        ...
        summary: "Learn the core concepts of Docker and containerization to streamline your development workflow.",
        content: "Full article content here...",
        category: "DevOps",
    ...
    },
    {
        ...
        summary: "A guide to designing RESTful APIs that are intuitive, efficient, and follow industry standards.",
        content: "Full article content here...",
        category: "API",
    ...
    },
    {
        ...
        summary: "Different Git workflow strategies for teams of various sizes and project complexities.",
        content: "Full article content here...",
    ...
    },
    {
        ...
        summary: "Practical guide to implementing TDD in your development process with real-world examples.",
        content: "Full article content here...",
        category: "Testing",
    ...
    },
    {
        ...
        summary: "Applying functional programming principles in JavaScript for cleaner, more maintainable code.",
        content: "Full article content here...",
        category: "JavaScript",
    ...
    },
    {
        ...
        summary: "Comprehensive guide to implementing web accessibility features for inclusive web applications.",
        content: "Full article content here...",
        category: "Web",
...
const WikiDashboard = () => {
    ...
    const filteredArticles = wikiArticles.filter(article => {
        ...
        const matchesDifficulty = filteredDifficulty === "All" ||
            article.difficulty === filteredDifficulty;
    ...
    const getDifficultyIcon = (difficulty: string) => {
        switch (difficulty) {
            ...
            case "Intermediate":
                return <StarHalf className="h-4 w-4 text-yellow-400" />;
            case "Advanced":
                return <><Star className="h-4 w-4 text-orange-400" /><Star className="h-4 w-4 text-orange-400" /></>;
            default:
                return null;
        }
    };
        ...
        <div className="flex flex-wrap gap-2 mb-4">
            {allCategories.map((category) => (
                <Badge
                    ...
                    className={`cursor-pointer transition-all ${selectedCategories.includes(category)
            ...
            <div className="flex flex-wrap gap-2">
                {["All", "Beginner", "Intermediate", "Advanced"].map((level) => (
                    <Badge
                        ...
                        className={`cursor-pointer transition-all ${filteredDifficulty === level
                            ? level === "All" ? "bg-gray-600" :
                                level === "Beginner" ? "bg-green-600" :
                                    level === "Intermediate" ? "bg-yellow-600" : "bg-orange-600"
                            : "bg-gray-800 text-gray-300 hover:bg-gray-700"
                            }`}
    ...
    return (
        <div className="min-h-screen h-full flex flex-col max-w-screen-xl mx-auto bg-transparent px-4 sm:px-6 md:px-8">
            <div className="top-0 z-20 pt-4 pb-3 mt-[15vh]">
                <div className="w-full max-w-screen px-4 md:px-12 py-10 bg-[rgba(15,23,42,0.6)] backdrop-blur-lg rounded-2xl mx-auto shadow-[0_0_30px_rgba(0,255,255,0.1)] relative overflow-hidden">
                    ...
                    <p className="text-sm md:text-base text-gray-300 leading-relaxed max-w-2xl">
                        Explore a curated collection of knowledge in tech, programming, and innovation. Bite-sized insights, always evolving — your go-to reference for everything digital.
                    </p>
                    ...
                    <div className="flex flex-wrap items-center gap-2 w-full md:w-auto justify-between md:justify-end">
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                Filters
                                {(selectedTags.length > 0 || selectedCategories.length > 0 || filteredDifficulty !== "All") && (
                                    <Badge className="ml-1 bg-indigo-600 text-white text-xs h-5 min-w-5 flex items-center justify-center p-0">
                                        {selectedTags.length + selectedCategories.length + (filteredDifficulty !== "All" ? 1 : 0)}
                                    </Badge>
                                )}
                            </Button>
            ...
            <div className="text-sm text-gray-400 mt-4 mb-2 flex justify-between items-center">
                <span>Showing {paginatedArticles.length} of {filteredArticles.length} articles</span>
                        ...
                        >
                            ...
                            >
                                ...
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className={`absolute bottom-2 right-2 h-8 w-8 rounded-full hover:bg-zinc-900 bg-gray-900/80 backdrop-blur-sm transition-opacity duration-200 ${hoveredArticleId === article.id || savedArticles.includes(article.id)
                                            ? "opacity-100"
                                            : "opacity-0"
                                        }`}
                                ...
                                <Badge
                                    className={`absolute top-2 left-2 ${article.difficulty === "Beginner"
                                            ? "bg-green-600/90"
                            ...
                            <div className={`relative z-10 p-4 flex flex-col ${viewMode === "list" ? "flex-1" : ""
                                ...
                                <div className="flex flex-wrap gap-1 mt-2">
                                    ...
                                    {article.tags.length > 3 && (
                                        <Badge variant="outline" className="bg-gray-800 border-gray-700 text-gray-400 text-xs">
                                            +{article.tags.length - 3}
                                        </Badge>
                                    )}
                                </div>
                                ...
                                <ShineBorder
                                    className={`absolute inset-0 pointer-events-none transition-opacity duration-500 ${hoveredArticleId === article.id ? "opacity-100" : "opacity-0"
                                        }`}
                                    duration={2}
                                    borderWidth={1}
                                />
